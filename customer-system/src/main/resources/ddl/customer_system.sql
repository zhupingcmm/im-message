...
CREATE TABLE `outsourcing_system` (
  ...
  `system_base_url` varchar(100) NOT NULL COMMENT '系统访问URL',
  `count_endpoint` varchar(100) NOT NULL COMMENT '系统更新数据数量路径',
  `sync_endpoint` varchar(100) NOT NULL COMMENT '系统更新数据路径',
